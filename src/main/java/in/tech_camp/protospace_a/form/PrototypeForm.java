...
public class PrototypeForm {
  ...
  public void validatePrototypeForm(BindingResult result) {
    if ((name == null || name.isEmpty())) {
      ...
      result.rejectValue("catchphrase", "error.Prototype",
          "Please enter either catchphrase");
    }
    else if (concept == null || concept.isEmpty()) {
      result.rejectValue("concept", "error.Prototype",
          "Please enter either concept");
    }
    else if (image == null || image.isEmpty()) {
      result.rejectValue("image", "error.Prototype",
          "Please enter either image");
    }
  }
}
